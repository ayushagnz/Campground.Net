...
namespace SD6503Assignment3.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public CustomersController(RetailDataBaseContext context)
        {
            _context = context;
        }
    ...
    /*    public async Task<IActionResult> Index()
        ...
        public async Task<IActionResult> Create([Bind("Cid,Name,Age,Phone,Email")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Cid,Name,Age,Phone,Email")] Customer customer)
        {
            if (id != customer.Cid)
            {
                return NotFound();
